...
if (
    ...
    if (
        ...
        $abonnementC->updateabonnement($abonnement, $_POST["ref"]);
...
<meta charset="UTF-8">
    ...
    <title>ciné-là Modifier Abonnement</title>
    <!--
...
<div class="" id="home">
    ...
    <?php
    if (isset($_POST['ref'])) {
        $abonnement = $abonnementC->showabonnement($_POST['ref']);
    ...
    ?>
        ...
        <div class="input-group mb-3">
            ...
            <input type="int" id="ref" name="ref" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" value="<?php echo $abonnement['ref']; ?>">
    </div>

    <div class="input-group mb-3">
            <label for="titre" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Titre</label>
            <input type="text" id="titre" name="titre" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" value="<?php echo $abonnement['titre']; ?>">
    </div>
    
    <div class="input-group mb-3">
            <label for="description" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Description</label>
            <input type="text" id="description" name="description" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" value="<?php echo $abonnement['description']; ?>">
    </div>

    <div class="input-group mb-3">
            <label for="prix" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Prix</label>
            <input type="int" id="prix" name="prix" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" value="<?php echo $abonnement['prix']; ?>">
    </div>
