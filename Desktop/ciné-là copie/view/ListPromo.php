...
<meta charset="UTF-8">
    ...
    <title>ciné-là List Promotions</title>
    <!--
...
<div class="" id="home">
        <div class="container">
            ...
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">List Promotions</h2>
    ...
    <thead>
        <tr class="tm-bg-gray">
            ...
            <th scope="col">ref</th>
            <th scope="col">ref_abonnement</th>
        ...
        ?>
            <tr>
                <td><?= $promo['ref']; ?></td>
                <td><?= $promo['ref_abonnement']; ?></td>
                <td><?= $promo['pourcentage']; ?> % </td>
                <td><?= $promo['date_debut']; ?></td>
                <td><?= $promo['date_fin']; ?></td>
                <td align="center">
                    <form method="POST" action="updatePromo.php">
                        <input class= "btn btn-primary" type="submit" name="Modifier" value="Modifier">
                        <input type="hidden" value="<?= $promo['ref']; ?>" name="ref">
                    </form>
                </td>
                <td>
                    <a class="fas fa-trash-alt tm-trash-icon" href="deletePromo.php?ref=<?= $promo['ref']; ?>"></a>
                </td>
            </tr>
        <?php
        }
